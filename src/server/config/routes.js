...
const field_visit = require('../routes/field_visit')
...
module.exports = function(app) {
	...
	app.use(`/api/${version}/field_visit`, field_visit)
	app.use(`/api/${version}/others`, others)
	app.use(`/api/${version}/events`, events)
	app.use(`/api/${version}/training`, training)
